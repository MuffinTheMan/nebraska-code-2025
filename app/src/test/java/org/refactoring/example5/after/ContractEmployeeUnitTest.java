        ...
        assertAll(
            () -> {
                ...
                assertAll(
                    ...
                    () -> assertThat(employee.getPayDescription()).isEqualTo("Billy Joel from Department 1 is a contractor paid $493.04 per week.")
                );
            },
            () -> {
                var employee = new ContractEmployee();
                ...
                assertAll(
                    ...
                    () -> assertThat(employee.getPayDescription()).isEqualTo("Jimmy Dean from Department 2 is a contractor paid $1032.8 per week (including a $20.5 weekly bonus).")
                );
            },
            () -> {
                var employee = new ContractEmployee();
                ...
                assertAll(
                    ...
                    () -> assertThat(employee.getPayDescription()).isEqualTo("Sara Lee from Department 3 is a contractor paid $2150.25 per week.")
                );
            },
            () -> {
                var employee = new ContractEmployee();
                ...
                assertAll(
                    ...
                    () -> assertThat(employee.getPayDescription()).isEqualTo("Julius Caesar from Department 4 is a contractor paid $8975.25 per week (including a $225.25 weekly bonus).")
                );
            }
        );
    }
